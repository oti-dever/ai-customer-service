...
#include "../services/platforms/pddweb_adapter.h"
#include "../services/platforms/qqrpa_adapter.h"
...
void PlatformBootstrap::initializeDefaultPlatforms(ConversationManager& manager)
{
    ...
    registerAdapter(router, new PddWebAdapter(&manager));
    registerAdapter(router, new QQRPAAdapter(&manager));
