...
QWidget* GroupReceptionDialog::buildLeftPanel()
{
    ...
    const QIcon IconIndex = QIcon(":/res/GroupReception/index.png");
    homeBtn->setIcon(IconIndex);
    ...
    modeCombo->addItem(QStringLiteral("仅转人工"));
    modeCombo->addItem(QStringLiteral("全部接待"));
    ...
    const QIcon IconHistory = QIcon(":/res/GroupReception/history.png");
    btnPending->setIcon(IconHistory);
    ...
    const QIcon IconMessage = QIcon(":/res/GroupReception/message.png");
    // btnAll->setIcon(style()->standardIcon(QStyle::SP_FileIcon));
    btnAll->setIcon(IconMessage);
