...
struct ReplyIntentDecision {
    ...
    QString modelIntentBeforeOverride;
    QString modelWorkflowBeforeOverride;
    QString fallbackIntent;
    QString fallbackWorkflow;
    QString fallbackReason;
    QString routeOverrideReason;
    QString activeEmailWorkflowStatus;
    QString activeEmailWorkflowReason;
    QStringList missingSlots;
    QStringList riskFlags;
    double confidence = 0.0;
    bool modelRouted = false;
    bool modelNeedDocSearchBeforeOverride = false;
    bool routeOverrideApplied = false;
    bool allowFallbackIntentOverride = false;
