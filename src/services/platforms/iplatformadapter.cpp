...
void IPlatformAdapter::sendMessagePart(const QString& conversationId,
                                       ...
                                       const QString& clientMessageId)
{
    ...
    emit sendFailed(conversationId, QStringLiteral("media_send_not_supported"), clientMessageId);
}
