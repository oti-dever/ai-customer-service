...
from ...core.win32_window import screen_to_client
...
from .header import pick_peer_name_from_ocr_blocks, peer_name_is_noise
from ...core.screenshot import capture_region, hwnd_capture_subrect_unobstructed
